...
class ImageGalleryController extends Controller
{
    ...
    public function datatables(){
        ...
        return Datatables::of($datas)
                            ...
                            ->editColumn('staff_id',function(ImageGallery $data){
                                return $staff_id = $data->staff_id ? $data->user->name : '';
                            })
                            ->rawColumns(['action','gallery','image_album_id','language_id','staff_id'])
                            ->toJson();
    }
    ...
    public function create(){
		...
		$users = User::where('is_staff',1)->pluck('name','id');
        return view('admin.image-gallery.create',compact('languages','users'));
    }
    ...
    public function edit($id){
		...
		$users = User::where('is_staff',1)->pluck('name','id');
        $languages = Language::orderBy('id','desc')->get();
        return view('admin.image-gallery.edit',compact('data','languages','users'));
    }
