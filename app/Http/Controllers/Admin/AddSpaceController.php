    ...
    public function datatables(){
        ...
        return Datatables::of($datas)
                            ...
                            ->editColumn('add_placement',function(Advertisement $data){
                                $add_placement = isset(config('placements')[$data->add_placement]) ? '<span class="badge badge-success">'.config('placements')[$data->add_placement].'</span>':'';
                                return $add_placement;
                            })
							->addColumn('click_count', function (Advertisement $data) {
								 $click_count = $data->link ? '<span class="badge badge-primary"><a href="'.$data->link.'" traget="_blank">'.$data->link.'</a></span>':'';
                                return $click_count;
							})
                            ...
                            ->rawColumns(['action','photo','add_placement','click_count','status'])
                            ->toJson();
    }
