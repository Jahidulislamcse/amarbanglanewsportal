...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Add Audio News') }}</h4>
                <ul class="links">
                    <li>
                        <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                    </li>
                    <li>
                        <a href="{{ route('categories.index') }}">{{ __('Audio News') }}</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Schedule Audio News') }} *</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <input type="submit" data-draft="0" class="btn btn-success submit-btn1" value="Save News">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
$("#audio_language_id").trigger('change');
    $('.tags').tagify();
</script>
@endsection
