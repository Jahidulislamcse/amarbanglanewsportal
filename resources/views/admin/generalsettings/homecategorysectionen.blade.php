...
<div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Home Category Section EN') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="">{{ __('Home Category Section EN') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      ...
                      <form class="uplogo-form" id="geniusform" action="{{ route('admin.generalsettings.update')}}"  method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
							...
							<input type="hidden" name="category_section_en" value="1">
						  	<div class="row">
								...
								<div class="menu-items col-lg-2">
									...
									@foreach ($categorlists as $category)
										@php
											$children = $category->child->where('language_id', 2);
