                ...
                <div class="product-description">
                    ...
                    <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                     <form id="geniusformdataedit"  action="{{ route('ads.update',$data->id)}}" method="POST"
							...
							<input type="hidden" name="addSize" value="size_750"/>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="left-area">
                                ...
                                <div class="col-lg-12">
                                    <select name="add_placement" id="placement">
                                       ...
                                       @foreach(config('placements') as $key => $placement)
											<option value="{{ $key }}" {{ $data->add_placement == $key ? 'selected' : '' }}>{{ __($placement) }}</option>
										@endforeach
