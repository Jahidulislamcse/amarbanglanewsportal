    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               columns: [
                    ...
                    { data: 'divisions', name: 'divisions', orderable:false, searchable:false },
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" data-href="{{route('admin.administator.create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
