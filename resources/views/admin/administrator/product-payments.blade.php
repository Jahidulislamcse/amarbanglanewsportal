...
<div class="content-area">
    ...
    <div class="mr-breadcrumb">
        <h4 class="heading">Product Payments</h4>
    </div>
    ...
    <form method="GET" class="filter-bar">
        ...
        <div class="row mt-2">
            <div class="col-md-12">
                ...
                <a href="{{ route('admin.administator.productPayments') }}"
        ...
        <div class="table-scroll">
            <table class="table table-hover">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($payment->order && $payment->order->items->count())
                                    -
                                @else
                                    &#2547; {{ number_format($payment->unit_price, 2) }}
                                @endif
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center">No product payments found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
