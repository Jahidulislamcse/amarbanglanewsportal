                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin.role.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                            <input type="text" class="input-field" name="name" placeholder="{{ __('Name EN') }}" value="">
                          </div>
                          ...
                          <div class="col-lg-4">
                            <input type="text" class="input-field" name="name_bn" placeholder="{{ __('Name BN') }}" value="">
                          </div>
                        </div>
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-4 d-flex justify-content-between">
                            ...
                            <label class="switch">
                              <input type="checkbox" name="section[]" value="product_orders">
                              <span class="slider round"></span>
                            </label>
                          </div>
                       </div>
