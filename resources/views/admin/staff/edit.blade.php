            ...
            <div style="display: flex; align-items: flex-start; gap: 12px;">
                ...
                <div>
                    <h5 style="margin: 0 0 6px 0; font-weight: bold; color: #c9302c; font-size: 16px;">
                        আবেদনকারী ওটিপি (OTP) ভেরিফাই করতে পারেননি / Unverified Phone & Email
                    </h5>
                    <p style="margin: 0; font-size: 13.5px; color: #444; line-height: 1.5;">
                        এই ব্যবহারকারী রেজিস্ট্রেশন সম্পন্ন করার সময় ওটিপি (OTP) কোড ভেরিফাই করতে পারেননি। 
                        অনুমোদন (Approve) করার পূর্বে ফোন নম্বর ভেরিফাই করে নিন।
                    </p>
                </div>
            </div>
        </div>
