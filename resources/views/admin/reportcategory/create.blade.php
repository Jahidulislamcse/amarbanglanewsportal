            ...
            <div class="col-lg-12">
                <div class="product-description">
                    ...
                    <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                     <form id="geniusformdata" action="{{ route('reportcategories.categoriesStore')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" class="input-field" name="title_bn"
                                        placeholder="{{ __('Title BN') }}" id="title_bn" autocomplete="off">
                                </div>
                            </div>
							 ...
							 <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" class="input-field" name="title_en"
                                        placeholder="{{ __('Title EN') }}" id="title_en" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="custom-control custom-radio d-inline-block mr-4">
                                        <input class="custom-control-input" type="radio" class="checklist2" name="status" id="yes" value="1" >
                                        <label class="custom-control-label" for="yes">{{__('Active')}}</label>
                                    </div>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input class="custom-control-input" type="radio" class="checklist2" name="status" id="no" value="0" checked> 
