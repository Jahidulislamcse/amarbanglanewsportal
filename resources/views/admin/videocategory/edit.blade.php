            ...
            <div class="col-lg-12">
                <div class="product-description">
                    ...
                    <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                     <form id="geniusformdata" action="{{ route('videocategories.categoriesUpdate',$data->id)}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" class="input-field" name="title" id="title" placeholder="{{ __('Title') }}" value="{{ $data->title }}" id="title">
                                </div>
                            </div>
							...
							<div class="row">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" class="input-field" name="slug" value="{{ $data->slug }}"
