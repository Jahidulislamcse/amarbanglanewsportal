...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Edit Video News') }}</h4>
                <ul class="links">
                    <li>
                        <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                    </li>
                    <li>
                        <a href="{{ route('categories.index') }}">{{ __('Video News') }}</a>
                    </li>
                </ul>
            </div>
        </div>
                                        ...
                                        <div class="row">
											...
											<select name="category_id" id="video_parent_id">
											   <option value="">Select category</option>
												@foreach (video_category($data->language_id) as $cat_id => $video_cat)
													<option value="{{ $cat_id }}" {{$cat_id == $data->category_id ? 'selected':''}}>{{ $video_cat }}</option>
												@endforeach
											</select>
                                            </div>
                                        </div>
                                ...
                                <div class="product-description">
                                    <div class="body-area">
									 ...
									 <div class="row">
                                        <div class="col-lg-6">
                                            <div class="left-area">
                                               <h4 class="heading">{{ __('Add to Home Video') }} *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="custom-control custom-radio d-inline-block mr-5">
                                                <input type="radio" class="custom-control-input"  name="is_slider" value="3" id="slider3" @if($data->is_slider ==3) checked @endif>
                                                <label for="slider3" class="custom-control-label">{{__('Yes')}}</label>
                                            </div>
                                             <div class="custom-control custom-radio d-inline-block mr-5">
                                                <input type="radio" class="custom-control-input" name="is_slider" value="2" id="slider4" @if($data->is_slider ==2) checked @endif> 
                                                <label for="slider4" class="custom-control-label">{{__('No')}}</label>
                                            </div>   
                                        </div>
                                    </div>
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="submit" data-draft="0" class="btn btn-success submit-btn1" value="Update Video News">
                                            </div>
                                        </div>
                                    </div>
                                </div>
