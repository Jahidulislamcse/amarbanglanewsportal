									...
									<div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="custom-control custom-radio d-inline-block mr-5">
                                                <input type="radio"  class="custom-control-input" name="is_slider" value="3" id="slider1"> 
                                                <label class="custom-control-label" for="slider1">{{__('Yes')}}</label>
                                            </div>
                                            <div class="custom-control custom-radio d-inline-block mr-5">
                                                <input type="radio"  class="custom-control-input" name="is_slider" value="2" id="slider2" checked> 
...
<script>
$("#video_language_id").trigger('change');
