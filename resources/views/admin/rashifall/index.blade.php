...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Rashifall') }}</h4>
                <ul class="links">
                    <li>
                        <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.rashifall.index') }}">{{ __('Rashifall') }}</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                <tr>
									...
									<th>{{ __('Type') }}</th>
                                    <th>{{ __('Date/Period') }}</th>
                                    <th>{{ __('Aries (মেষ রাশি) Preview') }}</th>
                                    <th>{{ __('Actions') }}</th>
                                </tr>
                            </thead>
                        </table>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('admin.rashifall.datatables') }}',
        columns: [
