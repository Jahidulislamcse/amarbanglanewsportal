        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="product-description">
                    ...
                    <form id="geniusformdata" action="{{ route('user.profile.paymentupdate',$data->id) }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
						...
						?>
							<div class="row">
								...
								<div class="col-lg-12">
									<input type="text" class="input-field" name="request_amount" onkeyup="getBlance(this.value)" placeholder="{{ __('Amount') }}" required="" value="{{$data->request_amount}}">
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<input type="text" class="input-field" name="request_amount" {{$disabled}} onkeyup="getBlance(this.value)" placeholder="{{ __('Amount') }}" required="" value="{{$data->request_amount}}">
								<?php if($disabled!=''){?>
						...
						<div class="row">
                            ...
                            <div class="col-lg-12">
							<input type="text" class="input-field" name="account_details" placeholder="{{ __('Account Details') }}" value="{{$data->account_details}}">
