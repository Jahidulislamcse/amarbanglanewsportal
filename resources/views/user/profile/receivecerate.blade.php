        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="product-description">
                    ...
                    <form id="geniusformdata" action="{{ route('user.profile.receivestore') }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
							<?php
							$number=$gs->payment_number;
							?>
							<input type="hidden" name="user_id" id="user_id" value="{{auth()->user()->id}}">
							<p style="color:red;font-weight:bold">বিজ্ঞাপন বাবদ  এই নাম্বারে টাকা পাঠান {{$number}}</p>
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<input type="text" class="input-field" name="amount" placeholder="{{ __('Amount') }}" required="" readonly value="500">
						...
						<div class="row">
                            <div class="col-lg-12">
                                <div class="left-area">
                                        <h4 class="heading">{{ __('Send By') }} *</h4>
                                </div>
                            </div>
                            <div class="col-lg-12">
