...
@section('content')
    <div class="content-area">
        ...
        <!-- Technical Maintenance Warning Banner -->
        <style>
            ...
            .maintenance-alert-wrapper {
                margin-top: 15px;
                margin-bottom: 25px;
                animation: warning-pulse 3s infinite ease-in-out;
                border-radius: 12px;
                transition: transform 0.2s ease, box-shadow 0.2s ease;
            }
            .maintenance-alert-wrapper:hover {
            ...
            .maintenance-alert-desc:last-child {
                margin-bottom: 0;
            }
            .maintenance-alert-desc a {
                color: #b45309;
                text-decoration: underline;
                font-weight: 700;
                transition: color 0.2s ease;
            }
            .maintenance-alert-desc a:hover {
                color: #78350f;
            }
        ...
        <div class="row mx-0 mb-4">
            <div class="col-md-12 p-0 maintenance-alert-wrapper">
