...
@section('content')
    <div class="content-area">
        ...
        @if(isset($notices) && $notices->count() > 0)
            ...
            <style>
                ...
                .dashboard-notice-header i {
                    font-size: 20px;
                }
                .dashboard-notice-header h5 {
                    margin: 0;
                    font-weight: 700;
                    font-size: 18px;
                ...
                .dashboard-notice-body {
                    padding: 20px;
                    max-height: 380px; /* matched height with video card body */
                    overflow-y: auto;
                ...
                .dashboard-notice-body::-webkit-scrollbar-track {
                    background: #f1f1f1;
                    border-radius: 10px;
                }
        ...
        @if (auth()->user()->is_approve == 0)
            <!-- NOT APPROVED: Show Notice full width if present -->
            @if(isset($notices) && $notices->count() > 0)
                <div class="col-md-12 mt-3 mb-4 p-0">
                    <div class="card dashboard-notice-card">
                        <div class="dashboard-notice-header">
                            <i class="fas fa-bullhorn"></i>
                            <h5>{{ __('Notice Board / নোটিশ বোর্ড') }}</h5>
                        </div>
                        <div class="dashboard-notice-body">
                            @foreach($notices as $notice)
                                <div class="notice-item-box">
                                    @if($notice->image)
                                        <img class="notice-item-icon-img" src="{{ asset('assets/images/notices/'.$notice->image) }}" alt="Notice Icon">
                                    @else
                                        <div class="notice-item-icon-placeholder">
                                            <i class="fas fa-bullhorn"></i>
                                        </div>
                                    @endif
                                    <div class="notice-item-details">
                                        <h6 class="notice-item-title">{{ $notice->title }}</h6>
            ...
            <div class="alert alert-success text-center font-weight-bold mb-4 pending-approval-alert" role="alert">
                ...
                <span style="vertical-align: middle;">
                    আপনার আবেদনটি কর্তৃপক্ষের অনুমোদনের জন্য অপেক্ষমান রয়েছে। এটি অনুমোদিত হওয়া পর্যন্ত অপেক্ষা করুন এবং
                    অনুমোদিত হওয়ার পর আমাদের আমার বাংলা ২৪-এর একজন প্রতিনিধি আপনার সাথে বিস্তারিত আলোচনার জন্য ব্যক্তিগতভাবে
                    যোগাযোগ করবেন।
                </span>
            </div>
        @endif
        ...
        @if (auth()->user()->is_approve == 1)
            @if(isset($notices) && $notices->count() > 0)
                <!-- Approved and Notices Exist: Show side-by-side layout -->
                <div class="row mt-3 mb-4">
                    <!-- Left Column: How to post news video -->
                    <div class="col-lg-6 mb-4">
                        <div class="card shadow-sm border-0 h-100"
                            style="border-radius: 12px; overflow: hidden; background: #ffffff; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                            <div class="card-header bg-gradient-primary text-white d-flex align-items-center"
                                style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); padding: 15px 20px; border: none;">
                                <i class="fab fa-youtube mr-3 text-white"
                                    style="font-size: 22px; vertical-align: middle; color: #ff0000 !important;"></i>
                            ...
                            <div class="card-body p-4 text-center d-flex flex-column justify-content-center">
                                <div class="embed-responsive embed-responsive-16by9 mx-auto"
                                    ...
                                    <iframe class="embed-responsive-item"
                                        src="https://www.youtube.com/embed/SECDlZDwCdc?si=VTavtMgUcoKM_WwH"
                    ...
                    <!-- Right Column: Notice Board Card -->
                    <div class="col-lg-6 mb-4">
                        <div class="card shadow-sm border-0 h-100 dashboard-notice-card">
                            <div class="dashboard-notice-header">
                                <i class="fas fa-bullhorn"></i>
                                <h5>{{ __('Notice Board / নোটিশ বোর্ড') }}</h5>
                            </div>
            ...
            @else
                <!-- Approved but No Notices: Show YouTube video full width -->
                <div class="col-md-12 mt-3 mb-4 p-0">
                ...
                <div class="chip-images">
                    @foreach ($topReporters as $reporter)
                        <img src="{{ $reporter->photo ? asset('assets/images/admin/' . $reporter->photo) : asset('assets/images/default-user.png') }}"
                            alt="{{ $reporter->name }}" title="{{ $reporter->name }}" />
                    @endforeach
                </div>
            </div>
                        ...
                        <div class="offer-body team-scroll">
                            ...
                            <div class="p-3 bg-light rounded border mb-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="font-weight-bold text-dark">টিম মেম্বার সংখ্যা: {{ bn($count) }}
                                        জন</span>
                                                    ...
                                                    <div class="text-dark">
                                                        ...
                                                        @if (!empty($u->phone))
                                                            <span class="text-muted font-weight-normal"
                                                                style="font-size: 12.5px; margin-left: 5px;">({{ $u->phone }})</span>
                                                        @endif
                                                    </div>
                                                    @if ($u->district_name || $u->thana_name)
                                                        <small class="text-muted font-weight-normal"
                                                            style="font-size: 11.5px; display: block; margin-top: 1px;">
                                                            <i class="fas fa-map-marker-alt text-danger mr-1"
                                                                style="font-size: 10px;"></i>{{ implode(', ', array_filter([$u->thana_name, $u->district_name])) }}
                                                        </small>
                                                    @endif
                                                </div>
                                            </li>
                ...
                <div class="col-md-6 mb-4">
                    <div class="offer-box">
                        ...
                        <div class="offer-body team-scroll" style="height: auto; max-height: 380px; overflow-y: auto;">
                            <div class="p-3 bg-light rounded border mb-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="font-weight-bold text-dark">কেনাকাটা করা মেম্বার:
                                        {{ bn($team_purchases->unique('user_id')->count()) }} জন</span>
                                    <span class="badge badge-warning font-weight-bold"
                                        style="background-color: #f59e0b; color: #fff; font-size: 13px;">কমিশন: ১০%</span>
                                </div>
                                        ...
                                        <div class="list-group-item px-0 py-2 border-bottom">
                                            <div class="d-flex align-items-center mb-1">
                                                ...
                                                <span class="font-weight-bold text-dark"
                                                    style="font-size: 13.5px;">{{ $tp->user->name ?? 'Deleted member' }}</span>
                                                @if (!empty($tp->user->phone))
                                                    <span class="text-muted ml-2"
                                                        style="font-size: 12px; font-weight: normal;">({{ $tp->user->phone }})</span>
                                                @endif
                                            </div>
                                            <div class="pl-4">
                                                <small class="d-block text-muted">
                                                    ...
                                                    @if ($tp->order && $tp->order->items)
                                                        {{ implode(
                                                            ', ',
                                                            $tp->order->items->map(function ($item) {
                                                ...
                                                <small
                                                    class="d-flex justify-content-between text-success font-weight-bold mt-1"
                                                    style="font-size: 13px;">
                                                    <span>মূল্য: ৳{{ number_format($tp->order_amount, 2) }}</span>
                                                    <span>কমিশন (১০%):
                                                        +৳{{ number_format($tp->commission_amount, 2) }}</span>
                                                </small>
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            <div class="row">
                                @forelse($products as $product)
                                    <div class="col-6 col-sm-6 col-md-3 col-lg-2 p-2">
                                        <div class="card h-100 shadow-sm p-3 product-card" data-id="{{ $product->id }}"
                                            data-name="{{ $product->name }}"
                                            data-price="{{ number_format($product->price, 2) }}"
                                            data-stock="{{ $product->stock }}" data-desc="{{ $product->description }}"
                                            data-slug="{{ $product->slug }}" data-images='@json($product->images->pluck('image_path'))'>
                                            ...
                                            <div class="">
                                                <span
                                                    class="product-name">{{ \Illuminate\Support\Str::limit($product->name, 40) }}</span>
                                                ...
                                                <div class="product-order-control mt-2"
                                                    ...
                                                    <input type="number" name="quantities[{{ $product->id }}]"
                                                        ...
                                                        value="{{ $product->stock > 0 ? 1 : 0 }}" min="1"
                                                        max="{{ $product->stock }}"
                                                        {{ $product->stock <= 0 ? 'disabled' : '' }}>
                                                    ...
                                                    @if ($product->slug === 'ti-sart')
                                                        <div class="tshirt-size-wrapper mt-2" style="display: none;">
                                                            <label
                                                                class="small font-weight-bold mb-1">{{ __('Size:') }}</label>
                                                            <select
                                                                class="form-control form-control-sm grid-tshirt-size-select">
                            ...
                            @if ($products->count())
                                <div class="row mt-3">
                                    <div class="col-md-3 mb-2">
                                        <input type="text" name="phone_number" id="paySelectedPhone"
                                    ...
                                    <div class="col-md-4 mb-2" id="paySelectedAddressWrapper">
                                        ...
                                        <small class="text-danger font-weight-bold d-block mt-1">
                                            ⚠️ পণ্যটি পেতে অনুগ্রহ করে বিস্তারিত ঠিকানা প্রদান করুন (গ্রাম, থানা, জেলা),
                                ...
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tbody>
                                        @forelse($orders as $order)
                                            <tr>
                                                <td>#{{ $order->id }}<br><small>{{ $order->transaction_id }}</small>
                                                </td>
                                                <td>
                                                    <ul class="mb-0 pl-3">
                        ...
                        <div class="card shadow-sm border-0 h-100">
                            ...
                            <div class="card-body d-flex flex-column text-center mt-4">
                                ...
                                @else
                                    ...
                                    <div class="pay-section collapse mt-2 text-start"
                                        id="paySectionCourse{{ $course->id }}">
                                        <form action="{{ route('course.pay', $course->id) }}" method="POST"
                                            ...
                                            <p class="text-muted small">Continue to EPS to complete this payment
                                                automatically.</p>

                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="phone_number_c_{{ $course->id }}">Contact Number</label>
                                                <input type="text" class="form-control" name="phone_number"
                                                    id="phone_number_c_{{ $course->id }}"
                                                    value="{{ auth()->user()->phone ?? '' }}" required>
                                            </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content" style="height: 680px; max-height: 90vh;">
                            ...
                            <div class="col-4 col-md-4">
                                ...
                                <div id="productImagesCarousel" class="carousel slide" data-ride="carousel">
                                    ...
                                    <button class="carousel-control-prev" type="button"
                                        data-target="#productImagesCarousel" data-slide="prev">
                                        <svg width="35" height="60" viewBox="0 0 24 24">
                                            <path d="M15 6 L9 12 L15 18" stroke="red" stroke-width="2" fill="none"
                                                stroke-linecap="round" />
                                        </svg>
                                    </button>

                                    <button class="carousel-control-next" type="button"
                                        data-target="#productImagesCarousel" data-slide="next">
                                        <svg width="35" height="60" viewBox="0 0 24 24">
                                            <path d="M9 6 L15 12 L9 18" stroke="red" stroke-width="2" fill="none"
                                                stroke-linecap="round" />
                                        </svg>
                                    </button>
                                </div>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div id="crossSellContainer" class="mb-3 p-3 bg-white rounded border">
                                        <h6 class="font-weight-bold text-primary mb-2" style="font-size: 14px;">
                                            ...
                                            {{ __('অন্যান্য আইটেম যুক্ত করুন (ঐচ্ছিক) / Add Add-on Items (Optional)') }}
                                        </h6>

                                        {{-- ID Card Suggestion Banner --}}
                                        <div id="idCardWarningBanner" class="alert alert-warning mb-3 d-none p-2"
                                            style="border-left: 4px solid #f59e0b; background-color: #fffbeb; font-size: 12px; text-align: left;">
                                            <i class="fas fa-exclamation-triangle text-warning mr-2"></i>
                                            <strong>আইডি কার্ডের সাথে প্রেস ফিতা (Press Fita) প্রয়োজন!</strong>
                                        </div>

                                        <div id="crossSellList" class="cross-sell-list-scrollable"
                                            style="max-height: 250px; overflow-y: auto; padding-right: 5px;">
                                            @foreach ($products as $prod)
                                                @php
                                                    $imgUrl = $prod->firstImage
                                                        ? asset(
                                                            'assets/images/products/' . $prod->firstImage->image_path,
                                                        )
                                                        : 'https://static.vecteezy.com/system/resources/previews/048/910/778/original/default-image-missing-placeholder-free-vector.jpg';
                                                @endphp
                                                <div class="d-flex align-items-center justify-content-between p-3 border rounded mb-3 cross-sell-item bg-light text-left"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="custom-control custom-checkbox mr-2">
                                                            <input type="checkbox"
                                                                class="custom-control-input cross-sell-checkbox"
                                                                id="addCrossProduct{{ $prod->id }}"
                                                                value="{{ $prod->id }}">
                                                            <label class="custom-control-label"
                                                                for="addCrossProduct{{ $prod->id }}"
                                                        ...
                                                        <div>
                                                            <h6 class="mb-0 font-weight-bold" style="font-size: 13px;">
                                                                {{ $prod->name }}
                                                                <span
                                                                    class="badge badge-warning recommendation-badge d-none ml-1"
                                                                    style="font-size: 10px;">{{ __('Recommended') }}</span>
                                                            </h6>
                                                            <span class="text-success font-weight-bold"
                                                                style="font-size: 12px;">৳
                                                                {{ number_format($prod->price, 2) }}</span>
                                                            @if ($prod->slug === 'ti-sart')
                                                                <div class="cross-sell-size-wrapper mt-1"
                                                                    style="display: none;">
                                                                    <label class="small mb-0">{{ __('Size:') }}</label>
                                                                    <select
                                                                        class="form-control form-control-sm cross-sell-size-select d-inline-block p-0 pl-1"
                                                                        style="width: 60px; height: 22px; font-size: 11px;">
                                                                        <option value="S">S</option>
                                                                        <option value="M" selected>M</option>
                                                                        <option value="L">L</option>
                                                                        <option value="XL">XL</option>
                                                    ...
                                                    <div class="d-flex align-items-center cross-sell-quantity-wrapper"
                                                        style="opacity: 0.5; pointer-events: none;">
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-secondary py-0 px-2 btn-minus"
                                                            style="font-size: 14px; font-weight: bold;">-</button>
                                                        <input type="number"
                                                            class="form-control form-control-sm text-center mx-1 addon-quantity"
                                                            value="1" min="1" max="{{ $prod->stock }}"
                                                            readonly style="width: 45px; height: 26px; padding: 2px;">
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-secondary py-0 px-2 btn-plus"
                                                            style="font-size: 14px; font-weight: bold;">+</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="row text-left">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="phone_number" id="productPayPhone"
                                                class="form-control" value="{{ auth()->user()->phone ?? '' }}"
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" name="quantity" id="productPayQuantity"
                                        ...
                                        <div class="col-md-12 mb-3" id="productPayAddressWrapper">
                                            ...
                                            <textarea name="address" id="productPayAddress" class="form-control" rows="3"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success font-weight-bold px-4" id="productPayButton">
                            <i class="fas fa-credit-card"></i>
                            Buy Now
                        </button>
                    </div>
        ...
        {{-- CONFIRMATION MODAL --}}
        <div class="modal fade" id="productPayConfirmModal" tabindex="-1" aria-labelledby="productPayConfirmModalLabel"
            aria-hidden="true">
                        ...
                        <div class="bg-light rounded p-3 mb-3 border text-left">
                            <div class="mb-2">
                                <span class="text-muted d-block"
                                    style="font-size: 11px;">{{ __('Phone Number') }}</span>
                                <strong id="confirmOrderPhone" style="font-size: 14px;"></strong>
                            </div>
                            <div>
                                <span class="text-muted d-block"
                                    style="font-size: 11px;">{{ __('Delivery Address') }}</span>
    ...
    @if (Session::has('registration_success_popup'))
        ...
        <div class="modal fade" id="regSuccessModal" tabindex="-1" role="dialog"
            aria-labelledby="regSuccessModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content"
                    style="border-radius: 20px; overflow: hidden; border: none; box-shadow: 0 15px 35px rgba(0,0,0,0.2);">
                    <div class="modal-header text-center"
                        style="background: linear-gradient(135deg, #1d976c 0%, #93f9b9 100%); border-bottom: none; padding: 35px 20px; position: relative; display: block;">
                        <button type="button" class="btn-close btn-close-white" data-dismiss="modal"
                            data-bs-dismiss="modal" aria-label="Close"
                            style="position: absolute; right: 20px; top: 20px; border: none; background: transparent; cursor: pointer; font-size: 20px; color: #fff; opacity: 0.8;">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <div
                            style="width: 75px; height: 75px; background: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto; box-shadow: 0 8px 20px rgba(29, 151, 108, 0.3);">
                    ...
                    <div class="modal-body text-center" style="padding: 40px 30px; background: #fff;">
                        <h3
                            style="font-family: 'SolaimanLipi', sans-serif; font-weight: 700; color: #1d976c; margin-bottom: 15px; font-size: 24px; line-height: 1.4;">
                            অভিনন্দন!</h3>
                        <h5
                            style="font-family: 'SolaimanLipi', sans-serif; font-weight: 600; color: #333; margin-bottom: 20px; font-size: 17px; line-height: 1.5;">
                            আমার বাংলা ২৪-এ আপনার নিবন্ধন সফলভাবে সম্পন্ন হয়েছে।</h5>
                        <p
                            style="font-family: 'SolaimanLipi', sans-serif; color: #666; font-size: 15px; line-height: 1.7; margin-bottom: 30px;">
                            কর্তৃপক্ষ কর্তৃক আপনার অ্যাকাউন্টটি অনুমোদিত হলে, আপনার করণীয় বিষয়সমূহ নিয়ে বিস্তারিত আলোচনার
                            জন্য আমাদের একজন প্রতিনিধি ব্যক্তিগতভাবে আপনার সাথে দ্রুত যোগাযোগ করবেন। অনুগ্রহ করে সে পর্যন্ত
                            অপেক্ষা করুন।
                        </p>
                        <button type="button" class="btn btn-success" data-dismiss="modal" data-bs-dismiss="modal"
                            style="background: linear-gradient(135deg, #1d976c 0%, #11998e 100%); border: none; padding: 12px 40px; border-radius: 30px; font-weight: 600; font-size: 15px; color: #fff; box-shadow: 0 4px 15px rgba(29, 151, 108, 0.4); cursor: pointer; outline: none; transition: all 0.3s ease;">
                            ঠিক আছে
                        </button>
                    </div>
                </div>
...
@section('scripts')
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-pprn3073KE6tl6vY5Jw6n4+DZv4pAP9HjT2yyL6w7C1gZ5+u+RW4my06MZ20kGmN" crossorigin="anonymous">
    </script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.cross-sell-item').forEach(item => {
                ...
                if (checkbox) {
                    checkbox.addEventListener('change', function() {
                        ...
                        const mainSlug = document.getElementById('productPayProductId').dataset
                            .slug || '';
            ...
            document.querySelectorAll('.products-section .product-card input[name="product_ids[]"]').forEach(
                checkbox => {
                    checkbox.addEventListener('change', function() {
                    ...
                    document.querySelectorAll('.cross-sell-item').forEach(item => {
                        ...
                        if (badge) {
                            if (isIdCard && itemSlug === 'pres-fita') {
                                ...
                                const qtyWrapper = item.querySelector(
            ...
            document.getElementById('productPayButton').addEventListener('click', function() {
                ...
                const deliveryCharge = parseFloat(zoneSelect.options[zoneSelect.selectedIndex].dataset
                    .charge);
                ...
                if (mainProductSlug === 'aidi-kard') {
                    const pressFitaItem = Array.from(document.querySelectorAll('.cross-sell-item')).find(
                        item => item.dataset.slug === 'pres-fita');
                    if (pressFitaItem) {
                ...
                const mainProductPrice = parseFloat(document.getElementById('modalProductPrice').innerText
                    .replace(/,/g, ''));
          ...
          `;
                ...
                if (mainProductSlug === 'ti-sart') {
                    ...
                    if (mainSizeSelect) {
                        ...
                        hiddenInputsHTML +=
                            `<input type="hidden" name="sizes[${mainProductId}]" value="${mainSize}">`;
                    }
                }
          ...
          `;
                ...
                document.querySelectorAll('.cross-sell-checkbox:checked').forEach(checkbox => {
                    ...
                    const addonQty = parseInt(itemWrapper.querySelector('.addon-quantity').value,
                        10) || 1;
              ...
              `;
                    ...
                    if (addonSlug === 'ti-sart') {
                        ...
                        if (addonSizeSelect) {
                            ...
                            hiddenInputsHTML +=
                                `<input type="hidden" name="sizes[${addonId}]" value="${addonSize}">`;
                        }
                    }
              ...
              `;
                ...
                document.getElementById('confirmOrderTotal').innerText = '৳ ' + totalAmount.toLocaleString(
                    'en-US', {
            ...
            if (paySelectedBtn) {
                paySelectedBtn.addEventListener('click', function() {
                    ...
                    const checkedCheckboxes = document.querySelectorAll(
                        '.products-section input[name="product_ids[]"]:checked');
              ...
              `;
                    ...
                    checkedCheckboxes.forEach(checkbox => {
                        ...
                        if (quantity > stock) {
                            stockError = true;
                            stockErrorMessage =
                                `${productNameDisplay} does not have enough stock. (Available: ${stock})`;
                        }
                  ...
                  `;
                        ...
                        if (slug === 'ti-sart') {
                            ...
                            if (sizeSelect) {
                                ...
                                itemHiddenInputsHTML +=
                                    `<input type="hidden" name="sizes[${productId}]" value="${sizeVal}">`;
                            }
                        }
                  ...
                  `;
                    ...
                    // Update confirm modal text/fields
                    document.querySelector('#confirmOrderTable tbody').innerHTML = tableBodyHTML;
                    document.getElementById('confirmOrderTotal').innerText = '৳ ' + totalAmount
