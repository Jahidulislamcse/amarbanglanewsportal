...
<?php if($subcategory){?>
 <a href="{{ route('frontend.category', $parent->title) }}"><i class="fa fa-chevron-right"></i> {{$parent->title}}</a><i class="fa fa-chevron-right"></i>  {{$subcategory}}
<?php }else{?>
 <i class="fa fa-chevron-right"></i> {{$parent->title}}<i class="fa fa-chevron-right"></i>  {{$subcategory}}
<?php }?>
