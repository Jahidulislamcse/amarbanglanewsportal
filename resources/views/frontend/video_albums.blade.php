...
<a href="{{ route('frontend.index')}}"><i class="fa fa-home" aria-hidden="true"></i> 
 ...
 <i class="fa fa-chevron-right"></i>{{ __('Video') }}
                ...
                <div class="{{ $datas->count() == 1 ? 'col-md-12 col-sm-12' : 'col-md-8 col-sm-8' }}">
                        <div class="small-img tab-border">
                            <img width="600" height="337"
                                 data-src="{{ $post->image_big ? url('assets/images/post/'.$post->image_big) : url('assets/images/noimage.png') }}"
                    ...
                    <h3 class="archive_title01">
                       <a href="{{ route('frontend.videodetails',$post->slug ) }}">
                                {{ $post->title }}
                            </a>
                    </h3>
